...
export default function PoliciesPage() {
  return (
    <div className="min-h-screen bg-white text-black font-sans selection:bg-zinc-100">
      <Suspense fallback={
        <main className="mx-auto max-w-4xl px-6 py-12 md:py-20 animate-pulse">
          <div className="h-4 w-24 bg-zinc-100 mb-8" />
          <div className="h-12 w-64 bg-zinc-100 mb-8" />
          <div className="h-4 w-full bg-zinc-100 mb-24" />
          <div className="space-y-24">
            <div className="h-32 w-full bg-zinc-50" />
            <div className="h-32 w-full bg-zinc-50" />
          </div>
        </main>
      }>
